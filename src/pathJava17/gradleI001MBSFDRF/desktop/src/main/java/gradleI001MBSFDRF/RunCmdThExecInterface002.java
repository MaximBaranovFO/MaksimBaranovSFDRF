 ...
 */
public interface RunCmdThExecInterface002 {
    public class ThreadsPerExecutorService   // (Mit noch fehlender Synchronisation, siehe unten)
{
   ...
   {ExeOutputFrameAnotherVersion002 runCmdWithResultIntoFrameAnotherVersion001 = new ExeOutputFrameAnotherVersion002();
      runCmdWithResultIntoFrameAnotherVersion001.mainOutExecIntoFrame();
   }
};
    public class ExeOutputFrameAnotherVersion002 extends JFrame {
public ExeOutputFrameAnotherVersion002() {
Runtime runtime;
Process process;
...
/*Process processAnotherVersion001 = Runtime.getRuntime().exec(
...
process = runtime.exec("cmd /c c:\\_bmv\\17JavaLearn\\MaksimBaranovSFDRF\\src\\pathCmd\\cmd3.bat");
...
new ExeOutputFrameAnotherVersion002();
}
}
}
